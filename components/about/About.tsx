...
const Card = ({
  ...
  return (
    <div
      ...
      className="border border-black/[0.2] group/canvas-card flex items-center justify-center max-w-[16rem] w-full mx-auto p-3 relative lg:h-[10rem] rounded-2xl ml-[-25px]"
      style={{
